...
type PageRepository interface {
	...
	CreateWithID(ctx context.Context, userID uuid.UUID, id uuid.UUID, parentID *uuid.UUID, title string, content []byte, icon *string, iconColor *string) (*model.Page, error)
	...
	IsTrashed(ctx context.Context, userID uuid.UUID, id uuid.UUID) (bool, error)
}
