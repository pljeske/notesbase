= notesbase
// When included by another document (e.g. docs/index.adoc), the parent sets
// :imagesdir: before the include and this guard is skipped.
ifndef::imagesdir[]
...
image::page-view.jpeg[notesbase overview]
image::page-view-slashmenu.jpeg[Rich text editor with multiple formats]
